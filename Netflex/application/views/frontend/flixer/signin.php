...
<!-- TOP LANDING SECTION -->
<div style="height:100vh;width:100%; clear: both; background-image: url(<?php echo base_url().'assets/frontend/'.$selected_theme;?>/images/home.png)">
	<!-- logo -->
	...
	<div class="row">
		<div class="col-lg-4 col-lg-offset-4" style="clear: both; margin-top: 200px;">
